...
class DownloadsControllerTest < ActionController::TestCase
  ...
  test "should create download" do
    assert_difference('Download.count') do
      post :create, download: { app_id: @download.app_id, download_date: @download.download_date, person_id: @download.person_id }
    end
  ...
  test "should update download" do
    patch :update, id: @download, download: { app_id: @download.app_id, download_date: @download.download_date, person_id: @download.person_id }
    assert_redirected_to download_path(assigns(:download))
  end
